...
def nuscenes_data_prep(root_path,
    ...
    #                             f'{out_dir}/{info_prefix}_infos_train.pkl',
    #                             virtual=virtual)
    create_groundtruth_database(dataset_class_name=dataset_name, data_path=root_path, info_prefix=info_prefix,
...
parser.add_argument(
    ...
    default=False,
    action='store_true',
    help='use mvp virtual points in gt database creation. now only support nuscenes trainval set')
