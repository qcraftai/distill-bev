...
class BEVDet(CenterPoint):
    ...
    def forward_test(self, points=None, img_metas=None, img_inputs=None, **kwargs):
        ...
        if not isinstance(img_inputs[0][0],list):
            ...
            return self.aug_test(None, img_metas[0], img_inputs[0])
...
class BEVDepth4D(BEVDepth_Base, BEVDetSequentialES):
    ...
    def extract_img_feat(self, img, img_metas, return_lss_feature=False, return_backbone_feature=False):
        ...
        # for bevdepth4d to bevdepth distillation
        outputs = []
        if return_lss_feature:
...
@DETECTORS.register_module()
class BEVDepth4DReproduceOfficial(BEVDepth4D):
    def __init__(self, **kwargs):
        super(BEVDepth4DReproduceOfficial, self).__init__(**kwargs)
