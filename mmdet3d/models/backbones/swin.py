...
# avoid duplicated registration in mmdetection
del BACKBONES._module_dict['SwinTransformer']
...
class SwinTransformer(BaseModule):
    ...
    def init_weights(self):
        if self.pretrained is None:
            ...
            logger.warning(f'loading swin backbone: {msg}')
