...
class OfficialViewTransformerLiftSplatShoot(BaseModule):
    def __init__(self, grid_config=None, data_config=None,
                 ...
                 **kwargs):
        super(OfficialViewTransformerLiftSplatShoot, self).__init__()
...
@NECKS.register_module()
class OfficialViewTransformerLSSBEVDepth(OfficialViewTransformerLiftSplatShoot):
    def __init__(self, extra_depth_net, loss_depth_weight, se_config=dict(),
                 dcn_config=dict(bias=True), **kwargs):
        super(OfficialViewTransformerLSSBEVDepth, self).__init__(**kwargs)
