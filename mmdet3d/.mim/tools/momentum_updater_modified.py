...
class CyclicMomentumUpdaterHook(MomentumUpdaterHook):
    ...
    def __init__(self,
                 ...
                 step_ratio_up=0.4,
                 ############
                 inserted_start_step_ratio=None,
                 inserted_start_target_ratio=None,
                 ############
                 **kwargs):
        ...
        ####################
        assert inserted_start_step_ratio is None or isinstance(inserted_start_step_ratio, float)
        assert inserted_start_target_ratio is None or isinstance(inserted_start_target_ratio, (int, float))
        self.inserted_start_step_ratio = inserted_start_step_ratio
        self.inserted_start_target_ratio = inserted_start_target_ratio
        ####################
    ...
    def before_run(self, runner):
        ...
        if self.inserted_start_step_ratio is None or self.inserted_start_target_ratio is None:
            ...
            inserted_start_iter = int(self.inserted_start_step_ratio * max_iter_per_phase)
            self.momentum_phases.append(
                [0, inserted_start_iter, max_iter_per_phase, self.inserted_start_target_ratio, self.inserted_start_target_ratio])
            self.momentum_phases.append(
                [inserted_start_iter, inserted_start_iter+iter_up_phase, max_iter_per_phase, 1, self.target_ratio[0]])
            self.momentum_phases.append([
                inserted_start_iter+iter_up_phase, max_iter_per_phase, max_iter_per_phase,
                self.target_ratio[0], self.target_ratio[1]
            ])
