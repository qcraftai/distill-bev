...
model = dict(
    ...
    pts_voxel_layer=dict(max_num_points=-1, point_cloud_range=point_cloud_range, max_voxels=(-1, -1)),
...
db_sampler = dict(
    ...
    info_path=data_root + 'nuscenes_10sweeps_virtual_dbinfos_train.pkl', # 10 random sweeps out of 10 sweeps
    rate=1.0,
    prepare=dict(
