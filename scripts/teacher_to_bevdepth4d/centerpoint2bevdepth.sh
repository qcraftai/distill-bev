...
filename=centerpoint2bevdepth.sh
logdir=/mnt/vepfs/ML/ml-users/dingwen/outputs/centerpoint_to_bevdepth4d_r50/
...
./tools/multi_node_dist_train.sh configs/lidar2camera_bev_distillation/centerpoint_pillar_to_bevdepth4d_r50/centerpoint_02pillar_second_secfpn_circlenms_8x4_cyclic_20e_nus_to_bevdepth4d_r50.py \
...
model.teacher_config='configs/dynamic_centerpoint/dynamic_centerpoint_02pillar_second_secfpn_4x8_cyclic_20e_nus.py' \
model.teacher_ckpt='/mnt/vepfs/ML/ml-users/zeyu/BEVDet/output/centerpoint/exp24_dynamic_centerpoint_02pillar_second_secfpn_4x8_cyclic_20e_nus/epoch_20.pth' \
